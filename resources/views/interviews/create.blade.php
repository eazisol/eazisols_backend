                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('interviews.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="home_town" id="home_town" class="form-control @error('home_town') is-invalid @enderror" value="{{ old('home_town') }}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="date_of_interview" id="date_of_interview" class="form-control @error('date_of_interview') is-invalid @enderror" value="{{ old('date_of_interview') }}" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="time" name="interview_time" id="interview_time" class="form-control @error('interview_time') is-invalid @enderror" value="{{ old('interview_time') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="position_applied" id="position_applied" class="form-control @error('position_applied') is-invalid @enderror" value="{{ old('position_applied') }}">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="interview_type" id="interview_type" class="form-control @error('interview_type') is-invalid @enderror" required>
                                            ...
                                            @foreach($interviewTypes as $type)
                                                <option value="{{ $type }}" {{ old('interview_type') == $type ? 'selected' : '' }}>{{ ucfirst($type) }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="round_type" id="round_type" class="form-control @error('round_type') is-invalid @enderror" required>
                                            ...
                                            <option value="first" {{ old('round_type') == 'first' ? 'selected' : '' }}>1st Interview</option>
                                            <option value="second" {{ old('round_type') == 'second' ? 'selected' : '' }}>2nd Interview</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_of_interviewer" id="name_of_interviewer" class="form-control @error('name_of_interviewer') is-invalid @enderror" value="{{ old('name_of_interviewer') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="technical_interview_conducted_by" id="technical_interview_conducted_by" class="form-control @error('technical_interview_conducted_by') is-invalid @enderror" value="{{ old('technical_interview_conducted_by') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="technical_remarks" id="technical_remarks" class="form-control @error('technical_remarks') is-invalid @enderror">{{ old('technical_remarks') }}</textarea>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="job_status" id="job_status" class="form-control @error('job_status') is-invalid @enderror">
                                            ...
                                            @foreach($jobStatuses as $status)
                                                <option value="{{ $status }}" {{ old('job_status') == $status ? 'selected' : '' }}>{{ ucfirst($status) }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="marital_status" id="marital_status" class="form-control @error('marital_status') is-invalid @enderror" value="{{ old('marital_status') }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="technical_skills" id="technical_skills" class="form-control @error('technical_skills') is-invalid @enderror" value="{{ old('technical_skills') }}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="last_company_name" id="last_company_name" class="form-control @error('last_company_name') is-invalid @enderror" value="{{ old('last_company_name') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="employee_count" id="employee_count" class="form-control @error('employee_count') is-invalid @enderror" value="{{ old('employee_count') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="last_job_position" id="last_job_position" class="form-control @error('last_job_position') is-invalid @enderror" value="{{ old('last_job_position') }}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="total_experience" id="total_experience" class="form-control @error('total_experience') is-invalid @enderror" value="{{ old('total_experience') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="relevant_experience" id="relevant_experience" class="form-control @error('relevant_experience') is-invalid @enderror" value="{{ old('relevant_experience') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="last_current_salary" id="last_current_salary" class="form-control @error('last_current_salary') is-invalid @enderror" value="{{ old('last_current_salary') }}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="notice_period" id="notice_period" class="form-control @error('notice_period') is-invalid @enderror" value="{{ old('notice_period') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="expected_salary" id="expected_salary" class="form-control @error('expected_salary') is-invalid @enderror" value="{{ old('expected_salary') }}">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select name="immediate_joining" id="immediate_joining" class="form-control @error('immediate_joining') is-invalid @enderror">
                                            <option value="0" {{ old('immediate_joining') == '0' ? 'selected' : '' }}>No</option>
                                            <option value="1" {{ old('immediate_joining') == '1' ? 'selected' : '' }}>Yes</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="reason_for_leaving" id="reason_for_leaving" class="form-control @error('reason_for_leaving') is-invalid @enderror">{{ old('reason_for_leaving') }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="communication_skills" id="communication_skills" class="form-control @error('communication_skills') is-invalid @enderror" value="{{ old('communication_skills') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="health_condition" id="health_condition" class="form-control @error('health_condition') is-invalid @enderror" value="{{ old('health_condition') }}">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select name="currently_studying" id="currently_studying" class="form-control @error('currently_studying') is-invalid @enderror">
                                            <option value="0" {{ old('currently_studying') == '0' ? 'selected' : '' }}>No</option>
                                            <option value="1" {{ old('currently_studying') == '1' ? 'selected' : '' }}>Yes</option>
                                        </select>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select name="interviewed_previously" id="interviewed_previously" class="form-control @error('interviewed_previously') is-invalid @enderror">
                                            <option value="0" {{ old('interviewed_previously') == '0' ? 'selected' : '' }}>No</option>
                                            <option value="1" {{ old('interviewed_previously') == '1' ? 'selected' : '' }}>Yes</option>
                                        </select>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-lg">Create Interview</button>
