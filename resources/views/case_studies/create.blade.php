                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('case_studies.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="tech_stack" id="tech_stack" class="form-control @error('tech_stack') is-invalid @enderror" rows="2">{{ old('tech_stack') }}</textarea>
                                @error('tech_stack')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea name="project_demand" id="project_demand" class="form-control @error('project_demand') is-invalid @enderror" rows="2">{{ old('project_demand') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="dedicated_team" id="dedicated_team" class="form-control @error('dedicated_team') is-invalid @enderror" value="{{ old('dedicated_team') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="client_location" id="client_location" class="form-control @error('client_location') is-invalid @enderror" value="{{ old('client_location') }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="solution_we_provide" id="solution_we_provide" class="form-control @error('solution_we_provide') is-invalid @enderror" rows="2">{{ old('solution_we_provide') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="result" id="result" class="form-control @error('result') is-invalid @enderror" rows="2">{{ old('result') }}</textarea>
                                @error('result')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
